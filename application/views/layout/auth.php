...
<?php
	...
	if(setting('bg_login')):
		$bg = ' style="
		background-image:url('.base_url(dir_upload('setting').setting('bg_login')).');
...
?>
<body class="body-login<?php echo ' '.setting('warna_dropdown'); ?>"<?= $bg ?>>
	<?php flash_message();  ?>
	<div class="container">
		<div class="row justify-content-center">
			<div class="col col-sm-6 col-md-4 mt-4 mt-md-6 mb-4">
				<div class="card">
